...
different causes that require different teaching responses. The taxonomy is:
`none`, `slip`, `missing_prerequisite`, `vocabulary_confusion`,
`local_procedural_gap`, `wrong_causal_model`, `overgeneralization`, and
`failed_transfer`.
